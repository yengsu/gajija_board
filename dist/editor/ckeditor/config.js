...
CKEDITOR.editorConfig = function( config ) {
	...
	//config.protectedSource.push(/<code>[\s\S]*?<\/code>/gi); // Code tags
		//config.protectedSource.push(/<code[^>]*><\/code>/g); // Code tags
	...
	config.extraPlugins = 'codemirror,tableresize,quicktable,codesnippet,widget,lineutils,widgetselection,clipboard,dialog,eqneditor';
