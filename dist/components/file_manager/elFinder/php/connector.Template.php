...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => $_SERVER['DOCUMENT_ROOT']. '/'.$_REQUEST["basedir"],
			//'URL'           => dirname($_SERVER['PHP_SELF']) . '/../files/', // URL to files (REQUIRED)
			//'URL'           => $_REQUEST["basedir"],
			'URL'           => $_REQUEST["basedir"],
			...
			'attributes' => array(
					array(
							'pattern' => '/(app|cache|tmp|conf|dev|dist|module|js|fonts|css|plugins|theme)$/',
							'read' => false,
							'write' => false,
							'hidden' => true,
							'locked' => true
					...
					array(
							'pattern' => '/(\.php|\.sql|\.json|\.md|\.xml|\.git|\.svn|\.htaccess|\.htpasswd|\.sh|\.log)$/',
							'read' => false,
							'write' => false,
							'hidden' => true,
							'locked' => true
...
function tpl_createDir($CreateDir, $perm=0777)
{
	if (!is_dir($CreateDir)) {
...
tpl_createDir('../../../../../'.$_REQUEST["basedir"]) ;
//tpl_createDir($_SERVER['DOCUMENT_ROOT']. '/'.$_REQUEST["basedir"]) ;
