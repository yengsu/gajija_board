...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'attributes' => array(
					array(
							'pattern' => '/(app|cache|tmp|conf|dist|dev|templates|module|js|html|fonts|css|plugins|theme|html.+)$/',
							'read' => false,
							'write' => false,
							'hidden' => true,
							'locked' => true
					...
					array(
							'pattern' => '/(\.php|\.js|\.sql|\.json|\.md|\.txt|\.xml|\.git|\.svn|\.htaccess|\.htpasswd|\.log)$/',
							'read' => false,
							'write' => false,
							'hidden' => true,
							'locked' => true
